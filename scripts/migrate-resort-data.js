...
// Firebase configuration - Load from config file
  ...
  try {
    ...
    for (const [categoryKey, resorts] of Object.entries(resortData)) {
      ...
      for (const resort of resorts) {
        ...
        const amenityIndex = resort.amenities.map((a) =>
    ...
    const categories = [
      {
        ...
        name: "Value Resorts",
        description:
          "Budget-friendly accommodations with Disney theming and amenities",
      ...
      },
      {
        ...
        description:
          "Mid-tier resorts with enhanced theming and table service dining",
      ...
      },
      {
        ...
        description:
          "Villa-style accommodations for Disney Vacation Club members",
    ...
    batch.set(statsDoc, {
      ...
      popularAmenities: [
        ...
        {
          name: "Gift Shop",
          count: Math.floor(totalResorts * 0.9),
          percentage: 90,
        },
        {
          name: "Fitness Center",
          count: Math.floor(totalResorts * 0.6),
          percentage: 60,
        },
      ],
