...
const SearchBox = memo(function SearchBox() {
  ...
  const handleSearch = useCallback(async () => {
    ...
    try {
      // Use the proxy service for geocoding
...
// Memoized marker component with optimized rendering
...
// Main map component
export const OptimizedInteractiveMap = memo<OptimizedInteractiveMapProps>(
  function OptimizedInteractiveMap({
    className,
    height = 500,
    width = '100%',
    showSearch = true,
...
// Memoized user location button
const UserLocationButton = memo(function UserLocationButton() {
